...
class HaveListFriendController {
  ...
  async AddFriendsRequset(req: Request, res: Response) {
    ...
    var check1 =
      await HaveListFriendController.haveListFriend.InsertListFriends(
        id,
        idFriend,
        "Request"
      );
  ...
  async CancelRequst(req: Request, res: Response) {
    ...
    var c = await Promise.all([
      HaveListFriendController.haveListFriend.CancelFriends(id, idFriend),
  ...
  async AcceptRequset(req: Request, res: Response) {
    ...
    var c = await Promise.all([
      HaveListFriendController.haveListFriend.AcceptRequset(id, idFriend),
  ...
  async GetAllFriend(req: Request, res: Response) {
    var id = req.cookies.id;
    var ls = await HaveListFriendController.haveListFriend.GetAllTypeFriend(
      id,
      "Friend"
    );
    res.json({
