...
export class MessController {
  ...
  async GetAllMessInbox(req: Request, res: Response) {
    ...
    var ls = await Promise.all([
      MessController.mess.GetAllContentByidBox(idBox, id),
  ...
  async SendMess(req: Request, res: Response) {
    ...
    let inbox = await MessController.haveListBoxChat.IsIdUserInBox(
      mess.idUser,
      mess.idBox
    );
    ...
    let v = await Promise.all([
      ...
      MessController.box.UpdateLastMessBox(
        mess.idUser,
        mess.content,
        mess.idBox,
        "Mess"
  ...
  async HiddenMess(req: Request, res: Response) {
    ...
    var data = await MessController.hiddenMess.GetHiddenMessByidMessidUser(
      idMess,
      id
    );
    if (data) {
  ...
  async Remove(req: Request, res: Response) {
    ...
    if (iduser == f.idUser + "") {
      await Promise.all([
        MessController.hiddenMess.DelHiddenMess(idmess),
