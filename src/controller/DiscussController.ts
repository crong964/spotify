...
class DiscussController {
  ...
  async PostDisscus(req: Request, res: Response) {
    ...
    var ls = await Promise.all([
      DiscussController.User.Get(d.User_Id),
  ...
  async GetMainDiscuss(req: Request, res: Response) {
    ...
    var ls = await Promise.all([
      DiscussController.disscuss.GetMainDiscussBySong_Id(SongId),
  ...
  async GetReplayDiscuss(req: Request, res: Response) {
    ...
    var ls = await DiscussController.disscuss.GetReplayDiscussByParentDiscussId(
      Parent_discuss_Id
    );
  ...
  async Delete(req: Request, res: Response) {
    ...
    if (ls[3]) {
      DiscussController.song.DeincreaseNumberDiscuss(
        ls[3].Song_Id,
        parseInt(ls[3].Replay_quality + "") + 1
      );
    }
