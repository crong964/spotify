...
export class HaveListFriendsService {
  ...
  async InsertListFriends(
    idUser: string,
    idFriend: string,
    IsFriend: "Request" | "Responsd" | "Friend"
  ) {
    var d: any = {
      Request: "0",
      Responsd: "1",
...
var haveListFriendsServiceImp = new HaveListFriendsService(
  new HaveListFriendsDatabase()
);
