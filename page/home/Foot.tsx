  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-6  text-[16px] p-4 sm:px-9 sm:py-[20px] my-16 border-y-2 border-[#121212] ">
      <div className="col-span-1">
        <div className="font-bold">Công ty</div>
      ...
      <div className="col-span-1">
        <div className="font-bold"> Cộng đồng</div>
        <div className="text-[#818181] hover:text-white cursor-pointer">
      ...
      <div className="col-span-1">
        <div className="font-bold">Liên kết hữu ích</div>
        <div className="text-[#818181] hover:text-white cursor-pointer">
          Hỗ trợ
        </div>
        <div className="text-[#818181] hover:text-white cursor-pointer">
      ...
      <div className="col-span-1">
        <div className="font-bold">Các gói của Spotify </div>
        <div className="text-[#818181] hover:text-white cursor-pointer">
          Premium Individual
        </div>
        <div className="text-[#818181] hover:text-white ">Premium Student </div>
        <div className="text-[#818181] hover:text-white cursor-pointer">
          Spotify Free
        </div>
      </div>
