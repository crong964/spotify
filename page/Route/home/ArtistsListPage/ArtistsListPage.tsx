...
export default function ArtistsListPage() {
  ...
  return (
    ...
    >
      ...
      <div className=" grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(190px,1fr))]">
        {children}
        {playlists.length < count ? (
          <div
            ...
            className="bg-[#B3B3B3] cursor-pointer text-white sm:hover:text-black sm:hover:bg-[#3BE477] flex size-[100px] sm:size-[180px] rounded-full justify-center items-center"
          >
            <div>Thêm ca sĩ</div>
          </div>
        ) : (
