...
export function PausePlaylistIcon(params: icon) {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className={`cursor-pointer ${params.className}`}
      viewBox="0 0 16 16"
    >
...
export function PlusCircleIcon(params: icon) {
  return (
    <svg aria-hidden="true" viewBox="0 0 16 16" className={`cursor-pointer ${params.className}`}>
...
export function ThreeDotsIcon(params: icon) {
  return (
    <svg className={`cursor-pointer ${params.className}`} aria-hidden="true" viewBox="0 0 24 24">
      <path d="M4.5 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm15 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm-7.5 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"></path>
    </svg>
  );
}
export function ChevronDownIcon(params: icon) {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export function PiPIcon(params: icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`cursor-pointer ${params.className}`}
...
export function MusicNoteBeamedIcon(params: icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export function TrashIcon(params: icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export function LibraryIcon(params: icon) {
  return (
    <svg
      data-encore-id="icon"
      aria-hidden="true"
...
export function XIcon(params: icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export function ProFileIcon(p: icon) {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export function PencilIcon(params: icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
