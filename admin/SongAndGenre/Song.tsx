...
export function Song({
  ...
  return (
    <div
      onClick={() => {
        dispatch(
          SelectSong({ Id: Id, SongImage: SongImage, SongName: SongName })
        );
      }}
    ...
    >
      <div className="col-span-3 flex items-center space-x-2">
        ...
        <img className="size-9" src={ImagePath(SongImage)} alt="" srcSet="" />
      </div>
      <div className="col-span-2">{SongName}</div>
      <div className="col-span-1 flex items-center space-x-4">
        {SelectList[Id] != undefined ? (
          <svg
            data-encore-id="icon"
            role="img"
            aria-hidden="true"
